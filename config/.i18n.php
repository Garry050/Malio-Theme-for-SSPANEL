...
$I18N['not-a-reason-to-use'] = array(
    ...
    'zh-cn' => '使うのに理由はいりません'. $I18N['appName']['zh-cn']
);
...
$I18N['index-section-1-feature-1-desc'] = array(
    ...
    'zh-cn' => '通常のプロバイダーよりもより少ない遅延で接続できます'
);
...
$I18N['index-section-1-feature-2-desc'] = array(
    ...
    'zh-cn' => '私達はShadowsocksRを利用しているため、macOS、iOS、Android、WindowsそしてLinuxにも対応しています'
);
...
$I18N['index-section-1-feature-3-desc'] = array(
    ...
    'zh-cn' => '自分でVPSを購入するのと比較してお金を節約できます！'
);
...
$I18N['index-section-1-feature-5-desc'] = array(
    ...
    'zh-cn' => '私達は一般的なプロバイダーとの接続が良いサーバーを厳選しています'
);
...
$I18N['index-section-2-title'] = array(
    ...
    'zh-cn' => 'スマートフォンでもノートパソコンでもデスクトップでも、いつでもどこでも私たちのサービスを利用できます'
);
$I18N['index-section-2-desc'] = array(
    ...
    'zh-cn' => $I18N['appName']['zh-cn'] . 'はShadowsocksRを採用しているため、サードパーティ製クライアントによってスマートフォンだけでなくPS4やNintendo Swithなどでも利用できます。'
);
...
$I18N['index-section-3-title'] = array(
    ...
    'zh-cn' => 'NetflixやAbemaTVを海外から、またその逆の場合も見れます'
);
...
$I18N['index-more-features'] = array(
    ...
    'zh-cn' => array(
        array(
            'icon' => 'fas fa-ad',
            'feature' => 'Shadowrocketと組み合わせてプロキシに接続しながら広告をブロックできます',
        ),
        array(
            'icon' => 'fas fa-filter',
            'feature' => '日本からアクセスできないサイトでもアクセスできるよう海外のサーバーも用意してあります',
        ),
        array(
            'icon' => 'fas fa-tachometer-alt',
            'feature' => '海外サーバーへ遅延を減らすことができます！ (CS:GO/Battlefield/LOL/Valorant/Apex Legends/PUBG等)',
        ),
        array(
            'icon' => 'fas fa-lock',
            'feature' => 'プライバシーを強化するために使用するならばご自身でShadowsocksRの暗号化方式を変更することができます！(一部のサーバーを除く)',
        ),
        array(
            'icon' => 'fas fa-fire',
            'feature' => '多くのプラットフォーム上の優れたアプリケーションと互換性があり、これらのアプリケーションは多くの革新的な企業や開発者によって開発されています',
        ),
    )
);
...
$I18N['dont-have-an-account-question-mark'] = array(
    ...
    'zh-cn' => '👉<a href="/auth/register">アカウントを作成する👈</a>'
...
$I18N['login_welcome'] = array(
    ...
    'zh-cn' => '<span class="font-weight-bold">' . $I18N['appName']['zh-cn'] . '</span>へようこそ！'
...
$I18N['closed-on-registeration'] = array(
    'en' => '$1 has closed on registeration',
    'zh-cn' => '現在新規登録は中止しています...'
##  'zh-cn' => '$1 已停止新用户注册'
);
$I18N['nickname'] = array(
    'en' => 'Nickname',
...
$I18N['email-code-desc'] = array(
    ...
    'zh-cn' => '受信されていない場合は迷惑メールを確認してください'
...
$I18N['no-available-data-alert'] = array(
    ...
    'zh-cn' => '残りデータ量が無いためサービスの利用を一時停止しています。左側メニューの「ストア」内の「データ量の追加購入」から購入してください'
...
$I18N['plan-expired-alert'] = array(
    ...
    'zh-cn' => 'データプランの期限が切れています。左側メニューの「ストア」からデータプランを再購入してください'
...
$I18N['no-enough-data-alert'] = array(
    ...
    'zh-cn' => '残りデータ量が5GBを下回っています。「ストア」内の「データ量の追加購入」からデータ量を購入することをお勧めします'
...
$I18N['new-user-guide-alert'] = array(
    ...
    'zh-cn' => '初めて利用しますか？<b>ダウンロード/使用方法</b>からクライアントをダウンロードしましょう！'
...
$I18N['data-add-on-item'] = array(
    'en' => '$1 CNY - $2GB Data Add-on',    ##要価格調整
    'zh-cn' => '$1 元 $2GB 流量叠加包'        ##要価格調整
##  'zh-cn' => '$1 元 $2GB 流量叠加包'        ##要価格調整
);
$I18N['store-title'] = array(
    'en' => 'Choose Your Subscription Plan',
    'zh-cn' => '希望のプランを選んでください'
##  'zh-cn' => '选择合适的会员订阅计划'
);
...
$I18N['read-before-subscribe-content'] = array(
    ...
    ',
    'zh-cn' => '
        <div class="bullet"></div> 必ず【利用規約】をよく読んでから購入してください<br>
        <div class="bullet"></div> データ量は購入日から30日ごとにリセットされ、未使用のデータ量は繰り越されません
    '
/*  'zh-cn' => '
...
$I18N['pay-now-modal-text'] = array(
    ...
    'zh-cn' => '「支払いを続ける」をクリックして支払画面に移動してください<br>
    支払いが完了するまでしばらく時間がかかる場合はがあります。このページを閉じる・更新等をしないでください'
...
$I18N['shop-dont-close-windows-hint'] = array(
    ...
    'zh-cn' => '支払いが完了するまでしばらく時間がかかる場合はがあります。このページを閉じる・更新等をしないでください'
...
$I18N['change-password-desc'] = array(
    ...
    'zh-cn' => 'アカウントを保護するために強度なパスワードを使用することを強く推奨します'
...
$I18N['connect-to-telegram-desc'] = array(
    ...
    'zh-cn' => 'Telegramと連携した場合、Telegramアカウントを使用してログインできるようになります'
...
$I18N['telegram-modal-desc'] = array(
    ...
    'zh-cn' => 'Copy this bind code and send to the Telegram Bot <a href="https://t.me/$1" target="blank">@$1</a>'     ##未翻訳
...
$I18N['currently-connected-to-telegram-account'] = array(
    'en' => 'Currently connected to Telegram account',
    'zh-cn' => '連携したTelegramアカウント'
##  'zh-cn' => '当前绑定 Telegram 账号'
);
...
$I18N['2fa-desc'] = array(
    ...
    'zh-cn' => 'より強固にアカウントを保護するために二段階認証を利用することを推奨します'
...
$I18N['2fa-modal-setp-1-desc'] = array(
    ...
    'zh-cn' => 'Google AuthenticatorまたはAuthyを使用してQRコードをスキャンしてください'
...
$I18N['2fa-modal-setp-2-desc'] = array(
    ...
    'zh-cn' => 'アプリ上に表示された6桁の数字を入力してください'
...
$I18N['delete-account-desc'] = array(
    ...
    'zh-cn' => 'アカウントを削除した場合、復元することはできません'
...
$I18N['no-affiliation-history'] = array(
    ...
    'zh-cn' => 'No Affiliation History'     ##要調整
##  'zh-cn' => '无返利记录'
);
$I18N['purchase-invitation-chances'] = array(
    'en' => 'Purchase Invitation Chances',
...
$I18N['config-history-notice'] = array(
    ...
    'zh-cn' => 'ここでは購読(Subscription)リンクを使用した履歴を確認できます。IPアドレスやUser-Agentを確認してアカウントや購読リンクが盗まれていないか確認できます'
...
$I18N['new-ticket-notice'] = array(
    ...
    'zh-cn' => '必ず左側メニューの「接続方法」内にある「よくある質問」を読んでから問い合わせしてください'
...
$I18N['server-settings-notice'] = array(
    ...
    'zh-cn' => '設定を変更した場合、必ずクライアント内のサーバーリストを更新または設定を再確認してください'
...
$I18N['server-password-desc'] = array(
    ...
    'zh-cn' => 'V2Rayユーザーへ … パスワードを変更した場合あなたのUUIDが変更されます。接続パスワード変更後は必ずクライアント内のサーバーリストを更新または設定を更新してください'
...
$I18N['encryption-desc'] = array(
    'en' => 'Be reminded that SS/SSD/SSR may vary in support of different encryption',
    'zh-cn' => 'SS/SSD/SSRでそれぞれ対応している暗号化方式が違います。<br>
    必ず使用しているクライアントを確認してから設定してください'
...
$I18N['protocol-desc'] = array(
    ...
    'zh-cn' => 'SS/SSD/SSRでそれぞれ対応しているプロコトルが違います。初心者の場合はSS/SSD/SSRで対応している「origin」または「_compatible」系を選んでください<br>
    「auth_chain」系のプロトコルは実験的なものです。接続が不安定になる恐れがあるので使用しないことを推奨します'
/*
...
$I18N['obfs-desc'] = array(
    'en' => 'Be reminded that SS/SSD/SSR may vary in support of different obfs<br>
    If you are using SS/SSD clients, make sure you understand how to download and install obfs plugins',
    'zh-cn' => 'SS/SSD/SSRでそれぞれ対応しているOBFSが違います。初心者の場合はSS/SSD/SSRで対応している「plain」または「_compatible」系を選んでください<br>
    もし接続にSS/SSDクライアントを使用している場合は必ずOBFS対応プラグインをインストールしてください'
/*
...
$I18N['reset-config-url-desc'] = array(
    ...
    'zh-cn' => '「リセット」をクリックすることで購読リンクを再生成できます。この操作は元に戻せません'
...
$I18N['reset-port-desc'] = array(
    ...
    'zh-cn' => '<p>随机更换一个端口使用，价格：<code>$1</code>元/次<br>重置后1分钟内生效</p>'               ##未使用
...
$I18N['audit-rules-notice'] = array(
    ...
    'zh-cn' => '本サービス・各サーバー及び利用者・接続先の安全性を確保するために本サービスは一部サービスに対して接続を遮断しています。<br>
    プライバシーについて：本サービスは以下の規制一覧のみに対して接続を遮断します。その他の通信先や通信内容を記録することはありません。またこれらは各利用者やISPを保護するために設定されています<br>
    御不便をおかけしますがご了承ください'
/*
...
$I18N['join-telegram-group-modal-text'] = array(
    ...
    'zh-cn' => '加入群组之前需要在 <a href="/user/profile">我的账号</a> 页面绑定 Telegram 账号，未绑定则无法加入群组。'        ##未使用
...
$I18N['your-account-has-been-deleted'] = array(
    'en' => 'アカウントを削除しました。またのご利用をお待ちしております',
    'zh-cn' => '您的账号已删除，后会有期！'
##  'zh-cn' => '您的账号已删除，后会有期！'
);
...
$I18N['unable-import-config-on-computer-modal'] = array(
    ...
    'zh-cn' => 'PC版では対応していません。スマートフォン側でインポートを押してください。'      ##要調整
